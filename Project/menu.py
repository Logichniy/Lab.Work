...
from config2 import Ui_Dialog
from config3 import Ui_Dialog_Graph
from config4 import Ui_Dialog_Tables
from settings2 import Ui_OtherWindow_1
from settings1 import Ui_OtherWindow
from settings3 import Ui_OtherWindow_2
