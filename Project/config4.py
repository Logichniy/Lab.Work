...
"background-color: rgb(0, 0, 0);")
    ...
    def retranslateUi(self, Dialog_Tables):
        ...
        self.pushButton.setText(_translate("Dialog_Tables", "Товарообіг"))
        self.pushButton_2.setText(_translate("Dialog_Tables", "Довідник товарів"))
        self.pushButton_3.setText(_translate("Dialog_Tables", "Валовий дохід"))
        self.pushButton_4.setText(_translate("Dialog_Tables", "Exit"))
        self.label_4.setText(_translate("Dialog_Tables", "Кіндратенко Ілля ФІТ 1-7"))